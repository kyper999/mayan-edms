        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                blank=True, choices=[
                    ...
                    ['ara', 'Arabic'],
                    [
                        'arc', 'Official Aramaic (700-300 BCE); Imperial '
                        'Aramaic (700-300 BCE)'
                    ...
                    ['crp', 'Creoles and pidgins'], ['cs', 'Kashubian'],
                    ...
                    [
                        'ina', 'Interlingua (International Auxiliary '
                    ...
                    ['jr', 'Judeo-Arabic'], ['kaa', 'Kara-Kalpak'],
                    ['ka', 'Kabyle'], ['kac', 'Kachin; Jingpho'],
                    ...
                    ['kir', 'Kirghiz; Kyrgyz'], ['km', 'Kimbundu'],
                    ...
                    ['lua', 'Luba-Lulua'], ['lu', 'Luba-Katanga'],
                    ...
                    ['no', 'Bokm\xe5l, Norwegian; Norwegian Bokm\xe5l'],
                    ['nog', 'Nogai'], ['non', 'Norse, Old'],
                    ['nor', 'Norwegian'], ['nqo', b"N'Ko"],
                    ['nso', 'Pedi; Sepedi; Northern Sotho'],
                    ['nu', 'Nubian languages'],
                    [
                        'nwc', 'Classical Newari; Old Newari; Classical '
                        'Nepal Bhasa'
                    ],
                    ...
                    [
                        'pro', 'Proven\xe7al, Old (to 1500); Occitan, Old '
                        '(to 1500)'
                    ],
                    ['pus', 'Pushto; Pashto'],
